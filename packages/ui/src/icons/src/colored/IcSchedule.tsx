...
const SvgIcSchedule = (props: SVGProps<SVGSVGElement>) => (
  ...
  >
    ...
    <rect
      ...
      fill="#D7D8E2"
      rx={3}
      transform="scale(-1 1)rotate(-45 -8.155 130.743)"
    />
    <rect
      width={6}
      height={6}
      ...
      fill="#D7D8E2"
      rx={3}
      transform="rotate(135 94.838 87.166)"
    />
    <rect
      width={6}
      height={6}
    ...
    <rect
      ...
      fill="#D7D8E2"
      rx={3}
      transform="rotate(90 104.143 57)"
    />
    ...
    <rect
      ...
      fill="#5680FF"
      rx={3.857}
      transform="rotate(90 86.143 56.143)"
    />
    <rect
      width={10.286}
      height={10.286}
