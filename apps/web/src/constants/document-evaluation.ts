import { documentEvaluation, DocumentEvaluationDataForUser } from "@web/types/document-evaluation";
...
export const documentEvaluationDummyDataForUser: DocumentEvaluationDataForUser = {
  applicationCode:'S2G3C9',
  title: '[한국대학생IT경영학회] 큐시즘 32기 학회원 모집',
  deadline: '2025-07-01',
  documentResult: {
  ...
  applicantList: [
    ...
    evaluationList: [
      {
        evaluation:
          '{평가 항목 대주제 / (컬처핏) 도전을 통해 성장하는 사람인가?}',
        evaluationDetail:
          '{평가 항목 대주제에 대한 설명 지금까지 가장 큰 성장을 이뤘던 때는 언제인지, 본인만의 커리어 목표는 무엇이며, 이를 위해 어떤 노력을 하는지}',
      },
      {
        evaluation:
          '{평가 항목 대주제 / (컬처핏) 도전을 통해 성장하는 사람인가?}',
